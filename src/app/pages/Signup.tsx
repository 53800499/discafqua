  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="absolute inset-0">
        <img
          src="https://images.unsplash.com/photo-1595637221004-de59e1c0a64c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx2aWN0b3JpYSUyMGZhbGxzJTIwd2F0ZXJmYWxsJTIwYWZyaWNhfGVufDF8fHx8MTc3NDM1Mjk5NHww&ixlib=rb-4.1.0&q=80&w=1080"
          alt="Background"
      ...
      >
        ...
        <div className="rounded-3xl border border-white/10 bg-black/40 p-8 backdrop-blur-xl">
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            {/* Name Input */}
            <div>
              <label className="mb-2 block text-sm text-gray-300">Nom</label>
